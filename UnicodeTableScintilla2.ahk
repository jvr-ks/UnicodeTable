...
setlexer(ctl)
{
    ctl.CaseSense := false ; turn off case sense, do this before setting keywords
    ;kw1 := ""
    ...
    ; ======================================================================
    ctl.WhiteSpace.View := 0
    ctl.LineEnding.View := 0
    ; ======================================================================

    ;ctl.callback := ctl_callback ; Adding a callback
    ctl.CustomSyntaxHighlighting := false ; turns syntax highlighting on
